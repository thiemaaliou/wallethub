 ...
 * 
 */
import { Component, NgModule, Injectable, Input, ChangeDetectorRef, ChangeDetectionStrategy  } from '@angular/core';
...
export class TestService {
    test:BehaviorSubject<string> = new BehaviorSubject("angular test #5");
...
export class TextChildComponent {
    ...
    constructor(private _srv:TestService, private _router:Router, private cdref: ChangeDetectorRef) {
